...
class FilePlayer extends put.ai.games.naiveplayer.UwU_Player {
...
class ThreadPlayer extends put.ai.games.naiveplayer.UwU_Player {
...
public class GameEngineImplTest {
    ...
    public void normalPlayer()
        ...
        Player p1 = new put.ai.games.naiveplayer.UwU_Player();
        Player p2 = new put.ai.games.naiveplayer.UwU_Player();
        game.addPlayer(p1);
        game.addPlayer(p2);
        game.play(null);
    }
